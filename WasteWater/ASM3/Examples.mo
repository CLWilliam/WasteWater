...
package Examples "Demonstration examples of the components of the ASM3 library"
  ...
  class SmallPlant "Small WWTP Configuration"
    ...
    ASM3.EffluentSink Effluent annotation(
      Placement(transformation(extent = {{88, -18}, {108, 2}})));
    ASM3.SludgeSink WasteSludge annotation(
      Placement(transformation(extent = {{86, -58}, {106, -38}})));
    ASM3.divider2 divider annotation(
      Placement(transformation(extent = {{20, -6}, {40, 14}})));
    ASM3.nitri tank3(K_A_NH = 0.4, V = 1333) annotation(
      Placement(transformation(extent = {{-6, -6}, {14, 14}})));
    ASM3.nitri tank2(K_A_NH = 0.4, V = 1333) annotation(
      Placement(transformation(extent = {{-32, -6}, {-12, 14}})));
    ASM3.deni tank1(K_A_NH = 0.4, V = 3000) annotation(
      Placement(transformation(extent = {{-68, -6}, {-48, 14}})));
    ASM3.mixer3 mixer annotation(
      Placement(transformation(extent = {{-104, 22}, {-84, 42}})));
    ASM3.WWSource WWSource annotation(
      Placement(transformation(extent = {{-88, 78}, {-68, 98}})));
    ASM3.blower blower1(Q_max = 34574.2654508612) annotation(
      Placement(transformation(extent = {{-32, -62}, {-12, -42}})));
    ASM3.blower blower2(Q_max = 34574.2654508612) annotation(
      Placement(transformation(extent = {{-6, -62}, {14, -42}})));
    ASM3.sensor_O2 sensor_O2 annotation(
    ...
    Modelica.Blocks.Sources.Constant Constant1 annotation(
      Placement(transformation(extent = {{-84, -86}, {-64, -66}})));
    ASM3.pump RecyclePump(Q_max = 46115) annotation(
    ...
    ASM3.pump ReturnPump(Q_max = 9223) annotation(
      Placement(transformation(origin = {26, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ASM3.pump WastePump(Q_max = 193) annotation(
    ...
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(fileName = Modelica.Utilities.Files.loadResource("modelica://WasteWater/Resources/ASM3/Inf_dry.txt"), table = [0, 0; 1, 1], columns = integer(({16, 10, 3, 4, 12, 10, 11, 15, 5, 6, 7, 10, 8})), tableName = "Inf_dry", tableOnFile = ("Inf_dry") <> "NoName") annotation(
      Placement(transformation(extent = {{-118, 78}, {-98, 98}})));
    sensor_NH sensor_NH1 annotation(
      Placement(transformation(extent = {{78, 16}, {94, 32}})));
    sensor_NO sensor_NO1 annotation(
      Placement(transformation(extent = {{92, 16}, {108, 32}})));
    sensor_COD sensor_COD1 annotation(
      Placement(transformation(extent = {{64, 16}, {80, 32}})));
    SecClar.Krebs.SecClarModKrebs Settler annotation(
      Placement(transformation(extent = {{50, -2}, {70, 18}})));
  equation
    ...
    connect(mixer.Out, tank1.In) annotation(
      Line(points = {{-84, 32}, {-79, 32}, {-79, 4}, {-68, 4}}));
    connect(mixer.In1, WWSource.Out) annotation(
      Line(points = {{-104, 35.9}, {-104, 74}, {-68, 74}, {-68, 81}, {-68.2, 81}}));
    ...
    connect(tank3.MeasurePort, sensor_O2.In) annotation(
      Line(points = {{9.5, 8.5}, {10, 8.5}, {10, 18}}));
    connect(Feedback.y, PI1.u) annotation(
      Line(points = {{81, 50}, {86, 50}}));
    connect(PI1.y, blower2.u) annotation(
      Line(points = {{109, 50}, {114, 50}, {114, -78}, {18, -78}, {18, -55}, {13.9, -55}}));
    connect(divider.Out2, RecyclePump.In) annotation(
      Line(points = {{40, 2.2}, {44, 2.2}, {44, -8.7}, {-74, -8.7}}));
    connect(RecyclePump.Out, mixer.In3) annotation(
      Line(points = {{-94.2, -14.9}, {-108, -14.9}, {-108, 26.6}, {-104, 26.6}, {-104, 27.1}}));
    connect(OxygenSetPoint.y, Feedback.u1) annotation(
      Line(points = {{61, 50}, {64, 50}}));
    connect(ReturnPump.Out, mixer.In2) annotation(
      Line(points = {{15.8, -28.9}, {-112, -28.9}, {-112, 32}, {-104, 32}}));
    connect(WastePump.Out, WasteSludge.In) annotation(
      Line(points = {{90.2, -26.9}, {100, -26.9}, {100, -34}, {80, -34}, {80, -49.2}, {86, -49.2}}));
    connect(Constant2.y, ReturnPump.u) annotation(
      Line(points = {{43, -58}, {46, -58}, {46, -28.5}, {34.8, -28.5}}));
    connect(Constant2.y, WastePump.u) annotation(
      Line(points = {{43, -58}, {60, -58}, {60, -26.5}, {71.2, -26.5}}));
    connect(sensor_O2.So, Feedback.u2) annotation(
      Line(points = {{19.8, 28}, {19.85, 28}, {19.85, 34}, {72, 34}, {72, 42}}));
    connect(blower1.u, Constant1.y) annotation(
      Line(points = {{-12.1, -55}, {-8, -55}, {-8, -76}, {-63, -76}}));
    connect(Temperature.y, tank1.T) annotation(
      Line(points = {{-81.5, 56}, {-74, 56}, {-74, 8}, {-71, 8}, {-71, 8}, {-68, 8}}, color = {0, 0, 255}));
    connect(Temperature.y, tank2.T) annotation(
      Line(points = {{-81.5, 56}, {-74, 56}, {-74, 14}, {-32, 14}, {-32, 8}}, color = {0, 0, 255}));
    connect(Temperature.y, tank3.T) annotation(
      Line(points = {{-81.5, 56}, {-74, 56}, {-74, 14}, {-5.9, 14}, {-5.9, 8}, {-5.8, 8}}, color = {0, 0, 255}));
    connect(CombiTableTime.y, WWSource.data) annotation(
      Line(points = {{-97, 88}, {-88, 88}}, color = {0, 0, 255}));
    connect(tank1.Out, tank2.In) annotation(
      Line(points = {{-48, 4}, {-32, 4}}));
    connect(RecyclePump.u, Constant1.y) annotation(
      Line(points = {{-75.2, -14}, {-46, -14}, {-46, -76}, {-64, -76}}, color = {0, 0, 255}));
    connect(Settler.Effluent, Effluent.In) annotation(
      Line(points = {{70.2, 13.7}, {72, 13.7}, {72, -6}, {88, -6}}));
    connect(Settler.Return, ReturnPump.In) annotation(
      Line(points = {{57, -1.6}, {57, -22.7}, {36, -22.7}}));
    connect(Settler.Waste, WastePump.In) annotation(
      Line(points = {{63, -1.6}, {63, -20.7}, {70, -20.7}}));
    connect(sensor_COD1.In, Settler.Effluent) annotation(
      Line(points = {{72, 16}, {72, 13.7}, {70.2, 13.7}}));
    connect(sensor_NH1.In, Settler.Effluent) annotation(
      Line(points = {{86, 16}, {86, 13.7}, {70.2, 13.7}}));
    connect(sensor_NO1.In, Settler.Effluent) annotation(
      Line(points = {{100, 16}, {100, 13.7}, {70.2, 13.7}}));
    connect(Settler.Feed, divider.Out1) annotation(
      Line(points = {{50, 8}, {40, 8}}));
    annotation(
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-118, -94}, {118, 98}}, grid = {2, 2}), graphics = {Line(points = {{-93, 88}, {-88, 88}})}),
...
Main Author:
  ...
  class BenchPlant "COST Benchmark WWTP Configuration"
    ...
    extends Modelica.Icons.Example;
    ASM3.EffluentSink Effluent annotation(
      Placement(transformation(extent = {{90, -16}, {110, 4}})));
    ASM3.SludgeSink WasteSludge annotation(
      Placement(transformation(extent = {{86, -58}, {106, -38}})));
    ASM3.SecClarModTakacs Settler annotation(
      Placement(transformation(extent = {{48, -2}, {68, 18}})));
    ASM3.divider2 divider annotation(
      Placement(transformation(extent = {{20, -6}, {40, 14}})));
    ASM3.nitri tank5(K_A_NH = 0.4, b_A_O_T = 0.1, V = 1333) annotation(
      Placement(transformation(extent = {{-6, -6}, {14, 14}})));
    ASM3.nitri tank4(K_A_NH = 0.4, b_A_O_T = 0.1, V = 1333) annotation(
      Placement(transformation(extent = {{-32, -6}, {-12, 14}})));
    ASM3.nitri tank3(K_A_NH = 0.4, b_A_O_T = 0.1, V = 1333) annotation(
      Placement(transformation(extent = {{-60, -6}, {-40, 14}})));
    ASM3.deni tank2(K_A_NH = 0.4, b_A_O_T = 0.1) annotation(
      Placement(transformation(extent = {{-48, 22}, {-28, 42}})));
    ASM3.deni tank1(K_A_NH = 0.4, b_A_O_T = 0.1) annotation(
      Placement(transformation(extent = {{-76, 22}, {-56, 42}})));
    ASM3.mixer3 mixer annotation(
      Placement(transformation(extent = {{-104, 22}, {-84, 42}})));
    ASM3.WWSource WWSource annotation(
      Placement(transformation(extent = {{-88, 78}, {-68, 98}})));
    ASM3.sensor_NO sensor_NO annotation(
      Placement(transformation(extent = {{-42, 48}, {-22, 68}})));
    ASM3.blower blower1(Q_max = 34574.2654508612) annotation(
      Placement(transformation(extent = {{-60, -62}, {-40, -42}})));
    ASM3.blower blower2(Q_max = 34574.2654508612) annotation(
      Placement(transformation(extent = {{-32, -62}, {-12, -42}})));
    ASM3.blower blower3(Q_max = 34574.2654508612) annotation(
      Placement(transformation(extent = {{-6, -62}, {14, -42}})));
    ASM3.sensor_O2 sensor_O2 annotation(
      Placement(transformation(extent = {{0, 18}, {20, 38}})));
    Modelica.Blocks.Math.Feedback Feedback annotation(
    ...
    Modelica.Blocks.Sources.Constant Constant1 annotation(
      Placement(transformation(extent = {{-84, -86}, {-64, -66}})));
    ASM3.pump RecyclePump(Q_max = 92230) annotation(
      Placement(transformation(origin = {-84, -12}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ...
    Modelica.Blocks.Sources.Step OxygenSetPoint(height = 2) annotation(
      Placement(transformation(extent = {{40, 40}, {58, 58}})));
    ...
    ASM3.pump ReturnPump(Q_max = 18446) annotation(
      Placement(transformation(origin = {26, -26}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ASM3.pump WastePump(Q_max = 385) annotation(
      Placement(transformation(extent = {{70, -34}, {90, -14}})));
    Modelica.Blocks.Sources.Constant Constant2 annotation(
      Placement(transformation(extent = {{22, -68}, {42, -48}})));
    Modelica.Blocks.Sources.Constant Temperature(k = 15) annotation(
      Placement(transformation(extent = {{-94, 50}, {-82, 62}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime(fileName = Modelica.Utilities.Files.loadResource("modelica://WasteWater/Resources/ASM3/Inf_rain.txt"), table = [0, 0; 1, 1], columns = integer(({2, 10, 3, 4, 12, 10, 11, 15, 5, 6, 7, 10, 8})), tableName = "Inf_rain", tableOnFile = ("Inf_rain") <> "NoName") annotation(
      Placement(transformation(extent = {{-118, 78}, {-98, 98}})));
    Modelica.Blocks.Nonlinear.FixedDelay FixedDelay1(delayTime = 1/6/24) annotation(
      Placement(transformation(extent = {{-18, 48}, {2, 68}})));
    sensor_NH sensor_NH1 annotation(
      Placement(transformation(extent = {{60, 18}, {76, 34}})));
    WasteWater.ASM3.sensor_NO sensor_NO1 annotation(
      Placement(transformation(extent = {{92, 18}, {108, 34}})));
    WasteWater.ASM3.sensor_COD sensor_COD1 annotation(
      Placement(transformation(extent = {{76, 18}, {92, 34}})));
  equation
    connect(divider.Out1, Settler.Feed) annotation(
      Line(points = {{40, 7}, {40, 9.4}, {48, 9.4}}));
    ...
    connect(Settler.Effluent, Effluent.In) annotation(
      Line(points = {{68.2, 13.7}, {72, 13.7}, {72, -4}, {90, -4}}));
    connect(mixer.In1, WWSource.Out) annotation(
      Line(points = {{-104, 35.9}, {-104, 74}, {-68, 74}, {-68, 77.5}, {-68.2, 77.5}, {-68.2, 81}}));
    ...
    connect(Constant1.y, blower1.u) annotation(
      Line(points = {{-63, -76}, {-35.1, -76}, {-35.1, -55}, {-40.1, -55}}));
    connect(divider.Out2, RecyclePump.In) annotation(
      Line(points = {{40, 2.2}, {44, 2.2}, {44, -8.7}, {-74, -8.7}}));
    connect(RecyclePump.Out, mixer.In3) annotation(
      Line(points = {{-94.2, -14.9}, {-108, -14.9}, {-108, 26.6}, {-104, 26.6}, {-104, 27.1}}));
    connect(OxygenSetPoint.y, Feedback.u1) annotation(
      Line(points = {{58.9, 49}, {62.5, 49}, {62.5, 50}, {64, 50}}));
    ...
    connect(PI2.y, RecyclePump.u) annotation(
      Line(points = {{79, 88}, {118, 88}, {118, -94}, {-106, -94}, {-106, -40}, {-66, -40}, {-66, -14.5}, {-75.2, -14.5}}));
    connect(Limiter1.y, Feedback1.u2) annotation(
      Line(points = {{29, 58}, {32, 58}, {32, 80}}));
    connect(Settler.Return, ReturnPump.In) annotation(
      Line(points = {{55, -1.6}, {55, -22.7}, {36, -22.7}}));
    connect(ReturnPump.Out, mixer.In2) annotation(
      Line(points = {{15.8, -28.9}, {-112, -28.9}, {-112, 32}, {-104, 32}}));
    connect(Settler.Waste, WastePump.In) annotation(
      Line(points = {{61, -1.6}, {61, -27.3}, {70, -27.3}}));
    connect(WastePump.Out, WasteSludge.In) annotation(
      Line(points = {{90.2, -21.1}, {100, -21.1}, {100, -34}, {80, -34}, {80, -49.2}, {86, -49.2}}));
    connect(Constant2.y, ReturnPump.u) annotation(
      Line(points = {{43, -58}, {46, -58}, {46, -28.5}, {34.8, -28.5}}));
    connect(Constant2.y, WastePump.u) annotation(
      Line(points = {{43, -58}, {58, -58}, {58, -21.5}, {71.2, -21.5}}));
    connect(sensor_O2.So, Feedback.u2) annotation(
      Line(points = {{19.8, 28}, {60, 28}, {60, 36}, {72, 36}, {72, 42}}));
    connect(blower2.u, Constant1.y) annotation(
      Line(points = {{-12.1, -55}, {-8, -55}, {-8, -76}, {-63, -76}}));
    connect(Temperature.y, tank1.T) annotation(
      Line(points = {{-81.5, 56}, {-78, 56}, {-78, 36}, {-75.8, 36}}, color = {0, 0, 255}));
    connect(Temperature.y, tank2.T) annotation(
      Line(points = {{-81.5, 56}, {-48, 56}, {-48, 36}}, color = {0, 0, 255}));
    connect(Temperature.y, tank3.T) annotation(
    ...
    connect(FixedDelay1.u, sensor_NO.Sno) annotation(
      Line(points = {{-20, 58}, {-22, 58}}, color = {0, 0, 255}));
    connect(Limiter1.u, FixedDelay1.y) annotation(
      Line(points = {{6, 58}, {4, 58}}, color = {0, 0, 255}));
    connect(sensor_NH1.In, Settler.Effluent) annotation(
      Line(points = {{68, 18}, {68, 13.7}}));
    connect(sensor_COD1.In, Settler.Effluent) annotation(
      Line(points = {{84, 18}, {84, 14}, {68, 14}}));
    connect(sensor_NO1.In, Settler.Effluent) annotation(
      Line(points = {{100, 18}, {100, 14}, {68.2, 14}}));
    annotation(
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-118, -94}, {118, 98}}, grid = {2, 2}), graphics = {Line(points = {{-93, 88}, {-88, 88}}), Line(points = {{-22.2, 58}, {-20, 58}}), Line(points = {{3, 58}, {6, 58}})}),
...
[1] J.B. Copp: The COST Simulation Benchmark. 2000. http://www.ensic.u-nancy.fr/COSTWWTP/
  ...
  model ComplexPlant "Complex ASM2d WWTP"
    ...
    blower blower1(Q_max = 162816) "there exist 4 blowers of 4240 Nm3/h each, Q_max adusted according active aerated tanks" annotation(
      Placement(transformation(extent = {{145, -13}, {165, 7}})));
    nitri nitri2(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 2772, alpha = 0.305, de = 5.24, R_air = 20) annotation(
      Placement(transformation(extent = {{110, 18}, {130, 38}})));
    deni anaerob(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 1287) annotation(
      Placement(transformation(extent = {{-138, 13}, {-118, 33}})));
    deni deni1(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 2772) annotation(
      Placement(transformation(extent = {{-80, 14}, {-60, 34}})));
    deni deni3(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 2772) annotation(
      Placement(transformation(extent = {{80, 18}, {100, 38}})));
    deni deni2(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 2772) annotation(
      Placement(transformation(extent = {{-20, 14}, {0, 34}})));
    nitri nitri3(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 5602, alpha = 0.305, de = 5.24, R_air = 21) annotation(
    ...
    pump RecyclePump(Q_max = 60480) annotation(
      Placement(transformation(origin = {10, -36}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ...
    ControlledDivider2 cdivider2 annotation(
      Placement(transformation(extent = {{-42, 67}, {-22, 87}})));
    ...
    divider2 divider2_1 annotation(
      Placement(transformation(origin = {57, -35}, extent = {{-10, -10}, {10, 10}}, rotation = 180)));
    ...
    nitri nitri1(k_H_T = 9.0, K_A_NH = 0.4, b_A_O_T = 0.1, V = 5602, alpha = 0.305, de = 5.24, R_air = 21) annotation(
    ...
    sensor_TSS sensor_TSS1 annotation(
      Placement(transformation(extent = {{-6, -87}, {14, -67}})));
    ...
    WasteWater.ASM3.sensor_NH sensor_NH1 annotation(
    ...
    WasteWater.ASM3.sensor_O2 sensor_O2_1 annotation(
      Placement(transformation(extent = {{164, 38}, {184, 58}})));
    WasteWater.ASM3.sensor_O2 sensor_O2_2 annotation(
      Placement(transformation(extent = {{14, 38}, {34, 58}})));
    WasteWater.ASM3.sensor_COD sensor_COD1 annotation(
      Placement(transformation(extent = {{134, -56}, {154, -36}})));
    WasteWater.ASM3.sensor_COD sensor_COD2 annotation(
      Placement(transformation(extent = {{-118, 94}, {-98, 114}})));
    WasteWater.ASM3.Examples.JenaSecClarModTakacs Settler(hsc = 3.46, Asc = 3704) "The depth is calculated based on V and A of the settler and not the true depth." annotation(
      Placement(transformation(extent = {{68, -84}, {88, -64}})));
    WasteWater.ASM3.sensor_TKN sensor_TKN1 annotation(
      Placement(transformation(extent = {{68, -56}, {88, -36}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime1(fileName = Modelica.Utilities.Files.loadResource("modelica://WasteWater/Resources/ASM3/drysim130303.txt"), table = [0, 0; 1, 1], columns = integer(({2})), tableName = "drysim130303", tableOnFile = ("drysim130303") <> "NoName") annotation(
      Placement(transformation(extent = {{-198, 96}, {-184, 112}})));
    Modelica.Blocks.Sources.CombiTimeTable CombiTableTime2(fileName = Modelica.Utilities.Files.loadResource("modelica://WasteWater/Resources/ASM3/drysim130303.txt"), table = [0, 0; 1, 1], columns = integer(({3, 7, 4, 6})), tableName = "drysim130303", tableOnFile = ("drysim130303") <> "NoName") annotation(
      Placement(transformation(extent = {{-142, 97}, {-126, 113}})));
    ...
    WasteWater.ASM3.sensor_O2 sensor_O2_3 annotation(
  ...
  equation
    ...
    connect(nitri3.Out, divider2_1.In) annotation(
      Line(points = {{164, 28}, {190, 28}, {190, -35.3}, {67.1, -35.3}}));
    connect(mixer2_5.Out, mixer3_1.In3) annotation(
      Line(points = {{-120, -4.6}, {-111, -4.6}, {-111, 19.1}, {-107, 19.1}}));
    ...
    connect(cdivider2.Out1, mixer2_2.In1) annotation(
      Line(points = {{-22, 80}, {40, 80}, {40, 29.5}, {50, 29.5}}));
    ...
    connect(Constant7.y, cdivider2.u) annotation(
      Line(points = {{-55.5, 103}, {-50.5, 103}, {-50.5, 54}, {-32, 54}, {-32, 70}}, color = {0, 0, 255}));
    ...
    connect(ControlledDivider2_1.Out2, mixer2_1.In2) annotation(
      Line(points = {{-51, -37.2}, {-52, -38.5}, {-52, 24.5}, {-45, 24.5}}));
    ...
    connect(Settler.Effluent, Effluent.In) annotation(
      Line(points = {{88.2, -68.3}, {108.65, -68.3}, {108.65, -68}, {144, -68}, {144, -60}, {170, -60}}));
    ...
    connect(Gain3.y, blower2.u) annotation(
      Line(points = {{108.7, -21}, {139, -21}, {139, -6}, {129.9, -6}}, color = {0, 0, 255}));
    connect(blower1.u, Gain2.y) annotation(
      Line(points = {{163.9, -6}, {195, -6}, {195, 103}, {165, 103}}, color = {0, 0, 255}));
    connect(Settler.Feed, divider2_1.Out1) annotation(
      Line(points = {{68, -72}, {38.1, -72}, {38.1, -38}, {47.1, -38}}));
    connect(RecyclePump.Out, ControlledDivider2_1.In) annotation(
      Line(points = {{0, -39}, {-30, -39}}));
    connect(RecyclePump.In, divider2_1.Out2) annotation(
      Line(points = {{21, -33}, {47, -33}}));
    connect(ReturnController1.out, ReturnPump.u) annotation(
      Line(points = {{-14, -108}, {-8, -108}, {-8, -97}, {-35, -97}}, color = {0, 0, 255}));
    connect(Settler.Return, ReturnPump.In) annotation(
      Line(points = {{75, -84}, {75, -91}, {-33, -91}}));
    connect(Settler.Return, sensor_TSS1.In) annotation(
      Line(points = {{75, -83.6}, {75, -91}, {4, -91}, {4, -87}}));
    connect(sensor_COD1.In, Settler.Effluent) annotation(
      Line(points = {{144, -57}, {144, -68}, {88, -68}}));
    connect(blower1.AirOut, nitri3.AirIn) annotation(
      Line(points = {{154, 7}, {154, 18}}));
    connect(nitri2.AirIn, blower2.AirOut) annotation(
      Line(points = {{120, 18}, {120, 7}}));
    connect(CombiTableTime2.y, Preclaryfier.MeasurePort) annotation(
      Line(points = {{-125, 105}, {-122, 105}, {-122, 87}}, color = {0, 0, 255}));
    connect(cdivider2.In, Preclaryfier.Out) annotation(
      Line(points = {{-42, 78}, {-116, 78}}));
    connect(mixer2_1.In1, deni1.Out) annotation(
      Line(points = {{-45, 29}, {-59, 29}, {-59, 24}, {-60, 24}}));
    connect(mixer3_1.In2, anaerob.Out) annotation(
      Line(points = {{-107, 23}, {-117, 23}}));
    connect(nitri1.Out, mixer2_2.In2) annotation(
      Line(points = {{32, 24}, {41, 24}, {41, 25}, {50, 25}}));
    connect(blower3.AirOut, nitri1.AirIn) annotation(
      Line(points = {{22, -3}, {22, 14.2}}));
    annotation(
