...
package Otterpohl "Secondary settling tank modelling by Otterpohl"
  ...
  package Interfaces "Connectors and partial ASM3 models for Secondary Clarifier Model by Otterpohl"
    extends Modelica.Icons.Package;
...
Copyright (C) 2003, Gerald Reichl
  ...
  model SecClarModOtter "Secondary Clarifier Model based on Otterpohl (ASM3)"
    ...
    // layers 1 to 10
    SCP.bottom_layer S1(zm = zm, Asc = Asc, ISV = ISV, rXi = rXi, rXs = rXs, rXh = rXh, rXsto = rXsto, rXa = rXa) annotation(
    ...
    SCP.top_layer S10(zm = zm, Asc = Asc, ISV = ISV, rXi = rXi, rXs = rXs, rXh = rXh, rXsto = rXsto, rXa = rXa) annotation(
...
(for micro and macro flocs).
      ...
      Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Polygon(points = {{52, -40}, {52, -58}, {44, -58}, {60, -68}, {76, -58}, {68, -58}, {68, -40}, {52, -40}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {223, 191, 159}, fillPattern = FillPattern.Solid), Polygon(points = {{-8, 58}, {-8, 40}, {10, 40}, {10, 32}, {22, 50}, {10, 66}, {10, 58}, {-8, 58}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {0, 127, 255}, fillPattern = FillPattern.Solid), Polygon(points = {{-68, -70}, {-68, -50}, {-76, -50}, {-60, -40}, {-44, -50}, {-52, -50}, {-52, -70}, {-68, -70}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {0, 127, 255}, fillPattern = FillPattern.Solid), Text(extent = {{-100, 20}, {100, -20}}, textString = "%name")}));
  end top_layer;
  annotation(
