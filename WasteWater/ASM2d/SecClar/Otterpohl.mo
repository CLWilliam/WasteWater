...
package Otterpohl "Secondary settling tank modelling by Otterpohl"
  ...
  package Interfaces "Connectors and partial ASM2d models for Secondary Clarifier Model by Otterpohl"
    extends Modelica.Icons.Package;
...
Parameters:
  ...
  model bottom_layer "Bottom layer of Otterpohls`s SC model"
    import WWSC = WasteWater.ASM2d.SecClar.Otterpohl.Interfaces;
