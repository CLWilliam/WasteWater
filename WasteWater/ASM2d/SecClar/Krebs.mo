...
package Krebs "Secondary settling tank modelling by Krebs (ASM2d)"
  ...
  package Interfaces "Partial models for Secondary Clarifier Model by Krebs"
    ...
    partial model SCVar "partial models providing variables"
      ...
      WWU.MassConcentration So1 "Dissolved oxygen in first stirrer tank of the excess layer";
      WWU.MassConcentration Sf1 "Readily biodegradable substrate in first stirrer tank of the excess layer";
      WWU.MassConcentration Sa1 "Fermentation products in first stirrer tank of the excess layer";
      WWU.MassConcentration Snh1 "Ammonium in first stirrer tank of the excess layer";
      WWU.MassConcentration Sno1 "Nitrate (plus nitrite) in first stirrer tank of the excess layer";
      WWU.MassConcentration Spo1 "Phosphate in first stirrer tank of the excess layer";
      WWU.MassConcentration Si1 "Inert, non biodegradable organics in first stirrer tank of the excess layer";
      WWU.Alkalinity Salk1 "Bicarbonate alkalinity in first stirrer tank of the excess layer";
      WWU.MassConcentration Sn2_1 "Dinitrogen in first stirrer tank of the excess layer";
      WWU.MassConcentration So2 "Dissolved oxygen in second stirrer tank of the excess layer";
      WWU.MassConcentration Sf2 "Readily biodegradable substrate in second stirrer tank of the excess layer";
      WWU.MassConcentration Sa2 "Fermentation products in second stirrer tank of the excess layer";
      WWU.MassConcentration Snh2 "Ammonium in second stirrer tank of the excess layer";
      WWU.MassConcentration Sno2 "Nitrate (plus nitrite) in second stirrer tank of the excess layer";
      WWU.MassConcentration Spo2 "Phosphate in second stirrer tank of the excess layer";
      WWU.MassConcentration Si2 "Inert, non biodegradable organics in second stirrer tank of the excess layer";
      WWU.Alkalinity Salk2 "Bicarbonate alkalinity in second stirrer tank of the excess layer";
      WWU.MassConcentration Sn2_2 "Dinitrogen in second stirrer tank of the excess layer";
      annotation(
...
// total sludge concentration in clarifier feed
    Xf = i_TSS_Xi*Feed.Xi + i_TSS_Xs*Feed.Xs + i_TSS_BM*(Feed.Xh + Feed.Xpao + Feed.Xa) + 3.23*Feed.Xpp + 0.6*Feed.Xpha + Feed.Xmeoh + Feed.Xmep;
// ratios of solid components
    rXi = Feed.Xi/Xf;
    rXs = Feed.Xs/Xf;
    rXh = Feed.Xh/Xf;
...
Parameters:
  ...
  ISV -  Sludge Volume Index [ml/g]
      "),
      Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}, grid = {2, 2}), graphics = {Rectangle(extent = {{-90, 14}, {92, -86}}, lineColor = {0, 0, 255}, lineThickness = 0.5), Line(points = {{-90, 48}, {92, 48}}, color = {0, 0, 255}, pattern = LinePattern.Dash), Rectangle(extent = {{-90, 80}, {92, 14}}, lineColor = {0, 0, 255}, lineThickness = 0.5), Polygon(points = {{-8, -20}, {-8, -38}, {-16, -38}, {0, -48}, {16, -38}, {8, -38}, {8, -20}, {-8, -20}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {223, 191, 159}, fillPattern = FillPattern.Solid), Polygon(points = {{-8, 34}, {-8, 54}, {-16, 54}, {0, 64}, {16, 54}, {8, 54}, {8, 34}, {-8, 34}}, lineColor = {0, 0, 255}, pattern = LinePattern.None, fillColor = {0, 127, 255}, fillPattern = FillPattern.Solid)}));
  end SecClarModKrebs;
  annotation(
